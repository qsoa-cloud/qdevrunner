...
import (
	...
	transportDfs "gopkg.qsoa.cloud/qdevrunner/transport/dfs"
	transportEmail "gopkg.qsoa.cloud/qdevrunner/transport/email"
	"gopkg.qsoa.cloud/qdevrunner/transport/grpcproxy"
	"gopkg.qsoa.cloud/qdevrunner/transport/httpproxy"
	"gopkg.qsoa.cloud/qdevrunner/transport/mysql"
	"gopkg.qsoa.cloud/qdevrunner/transport/opentracing"
	"gopkg.qsoa.cloud/qdevrunner/transport/prometheus"
)
